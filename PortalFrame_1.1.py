...
class master_window:
        ...
        def __init__(self,master):
            ...
            self.w3=tk.StringVar()
            self.w4=tk.StringVar()
            self.P=tk.StringVar()
...
# =============================================================================
            ...
            tk.OptionMenu(frame1,self.frametype,'1 bay 1 story','2 bay 1 story','1 bay 2 story','2 bay 2 story').grid(row=2,column=2)                                          
            ...
            def build_frame(self,*event):
                ...
                if frametype=='2 bay 2 story':
                    ...
                    bmA_label=tk.Label(canvas,text="Beam Area (in^2):")
                    canvas.create_window(startx+xdim/4-60,starty-ydim/2+2,window=bmA_label,anchor='nw')
                    bmA_entry=tk.Entry(width=8,textvariable=self.bmA)
                    canvas.create_window(startx+xdim/4-60,starty-ydim/2+18,window=bmA_entry,anchor='nw')
                    
                    bmI_label=tk.Label(canvas,text="Beam I (in^4):")
                    canvas.create_window(startx+xdim/4-60,starty-ydim/2+34,window=bmI_label,anchor='nw')
                    bmI_entry=tk.Entry(width=8,textvariable=self.bmI)
                    canvas.create_window(startx+xdim/4-60,starty-ydim/2+50,window=bmI_entry,anchor='nw')
                    ...
                    w2_label=tk.Label(canvas,text="w (plf):")
                    canvas.create_window(startx+xdim/4-50,starty-ydim/2-64,window=w2_label,anchor='nw')
                    w2_entry=tk.Entry(width=8,textvariable=self.w2)
                    canvas.create_window(startx+xdim/4+5,starty-ydim/2-64,window=w2_entry,anchor='nw')
                    
                    P2_label=tk.Label(canvas,text="P (lbs):")
                    canvas.create_window(startx+xdim/4-50,starty-ydim/2-48,window=P2_label,anchor='nw')
                    P2_entry=tk.Entry(width=8,textvariable=self.P2)
                    canvas.create_window(startx+xdim/4+5,starty-ydim/2-48,window=P2_entry,anchor='nw')
                    
                    x2_label=tk.Label(canvas,text="P @ (ft):")
                    canvas.create_window(startx+xdim/4-50,starty-ydim/2-32,window=x2_label,anchor='nw')
                    x2_entry=tk.Entry(width=8,textvariable=self.x2)
                    canvas.create_window(startx+xdim/4+5,starty-ydim/2-32,window=x2_entry,anchor='nw')
                    
                    w3_label=tk.Label(canvas,text="w (plf):")
                    canvas.create_window(startx+xdim*3/4-50,starty-ydim/2-64,window=w3_label,anchor='nw')
                    w3_entry=tk.Entry(width=8,textvariable=self.w3)
                    canvas.create_window(startx+xdim*3/4+5,starty-ydim/2-64,window=w3_entry,anchor='nw')
                    
                    P3_label=tk.Label(canvas,text="P (lbs):")
                    canvas.create_window(startx+xdim*3/4-50,starty-ydim/2-48,window=P3_label,anchor='nw')
                    P3_entry=tk.Entry(width=8,textvariable=self.P3)
                    canvas.create_window(startx+xdim*3/4+5,starty-ydim/2-48,window=P3_entry,anchor='nw')
                    
                    x3_label=tk.Label(canvas,text="P @ (ft):")
                    canvas.create_window(startx+xdim*3/4-50,starty-ydim/2-32,window=x3_label,anchor='nw')
                    x3_entry=tk.Entry(width=8,textvariable=self.x3)
                    canvas.create_window(startx+xdim*3/4+5,starty-ydim/2-32,window=x3_entry,anchor='nw')
                    
                    w4_label=tk.Label(canvas,text="w (plf):")
                    canvas.create_window(startx+xdim*3/4-50,starty-ydim-64,window=w4_label,anchor='nw')
                    w4_entry=tk.Entry(width=8,textvariable=self.w4)
                    canvas.create_window(startx+xdim*3/4+5,starty-ydim-64,window=w4_entry,anchor='nw')
                    
                    P4_label=tk.Label(canvas,text="P (lbs):")
                    canvas.create_window(startx+xdim*3/4-50,starty-ydim-48,window=P4_label,anchor='nw')
                    P4_entry=tk.Entry(width=8,textvariable=self.P4)
                    canvas.create_window(startx+xdim*3/4+5,starty-ydim-48,window=P4_entry,anchor='nw')
                    
                    x4_label=tk.Label(canvas,text="P @ (ft):")
                    canvas.create_window(startx+xdim*3/4-50,starty-ydim-32,window=x4_label,anchor='nw')
                    x4_entry=tk.Entry(width=8,textvariable=self.x4)
                    canvas.create_window(startx+xdim*3/4+5,starty-ydim-32,window=x4_entry,anchor='nw')
...
# =============================================================================
            ...
            def combine_matrices_2b2s(col1matrix,col2matrix,col3matrix,col4matrix,col5matrix,col6matrix,bm1matrix,bm2matrix,bm3matrix,bm4matrix):
                global_matrix=np.zeros((27,27))
                
                global_matrix[0:6,0:6]+=col1matrix
                global_matrix[3:9,3:9]+=col2matrix
                global_matrix[9:15,9:15]+=col3matrix
                global_matrix[12:18,12:18]+=col4matrix
                global_matrix[18:24,18:24]+col5matrix
                global_matrix[21:,21:]+=col6matrix
                
                global_matrix[3:6,3:6]+=bm1matrix[:3,:3]
                global_matrix[3:6,12:15]+=bm1matrix[:3,3:]
                global_matrix[12:15,3:6]+=bm1matrix[3:,:3]
                global_matrix[12:15,12:15]+=bm1matrix[:3,:3]
                
                global_matrix[6:9,6:9]+=bm2matrix[:3,:3]
                global_matrix[6:9,15:18]+=bm2matrix[:3,3:]
                global_matrix[15:18,6:9]+=bm2matrix[3:,:3]
                global_matrix[15:18,15:18]+=bm2matrix[:3,:3]
                
                global_matrix[12:15,12:15]+=bm3matrix[:3,:3]
                global_matrix[12:15,21:24]+=bm3matrix[:3,3:]
                global_matrix[21:24,12:15]+=bm3matrix[3:,:3]
                global_matrix[21:24,21:24]+=bm3matrix[:3,:3]
                
                global_matrix[15:18,15:18]+=bm4matrix[:3,:3]
                global_matrix[15:18,24:27]+=bm4matrix[:3,3:]
                global_matrix[24:27,15:18]+=bm4matrix[3:,:3]
                global_matrix[24:27,24:27]+=bm4matrix[:3,:3]
            ...
            def member_forces(deflections,x,y,L,localk,F):
                memT=T(x,y,L)
                memTt=np.transpose(memT)
                u=np.matmul(memT,deflections)
                Q=np.matmul(localk,u)-F
                R=np.matmul(memTt,Q)
                return R
            ...
            def run(self,*event):
                ...
                if frametype=='1 bay 1 story':
                    ...
                    col1R=member_forces(col1v,0,height,height,col1localk,colF)
                    col2R=member_forces(col2v,0,-1*height,height,col2localk,colF)
                    bmR=member_forces(bmv,width,0,width,bmlocalk,F)                                                            
                ...
                if frametype=='2 bay 1 story':
                    ...
                    col1R=member_forces(col1v,0,height,height,col1localk,colF)
                    col2R=member_forces(col2v,0,-1*height,height,col2localk,colF)
                    col3R=member_forces(col3v,0,-1*height,height,col3localk,colF)
                    bm1R=member_forces(bm1v,width,0,width,bm1localk,F[0:6])
                    bm2R=member_forces(bm2v,width2,0,width2,bm2localk,F[3:])                                        
                ...
                if frametype=='1 bay 2 story':
                    ...
                    col2props=[E,colA,colI,height,'dn',fixity]
                    col2dofs=[6,7,8,9,10,11]
                    col3props=[E,colA,colI,height2,'up','1']
                    col3dofs=[3,4,5,12,13,14]
                    col4props=[E,colA,colI,height2,'up','1']
                    ...
                    col1globalk=global_transform(col1localk,0,height,height)
                    col2globalk=global_transform(col2localk,0,-1*height,height)
                    col3globalk=global_transform(col3localk,0,height2,height2)
                    col4globalk=global_transform(col4localk,0,height2,height2)
                    bm1globalk=global_transform(bm1localk,width,0,width)
                    ...
                    col1R=member_forces(col1v,0,height,height,col1localk,colF)
                    col2R=member_forces(col2v,0,-1*height,height,col2localk,colF)
                    col3R=member_forces(col3v,0,-1*height2,height2,col3localk,colF)
                    col4R=member_forces(col4v,0,-1*height2,height2,col4localk,colF)
                    bm1R=member_forces(bm1v,width,0,width,bm1localk,F[0:6])
                    bm2R=member_forces(bm2v,width,0,width,bm2localk,F[6:])
                    ...
                    bm1M=beam_moment(-1*bm1R[2],bm1R[5],P,x,w,width)
                    bm2M=beam_moment(-1*bm2R[2],bm2R[5],P2,x2,w2,width)
                    col1M=[-1*col1R[2]/12,col1R[5]/12]
                    col2M=[col2R[2]/12,-1*col2R[5]/12]     
                    col3M=[col3R[2]/12,-1*col3R[5]/12]  
                ...
                if frametype=='2 bay 2 story':
                    ...
                    height2=float(self.height2.get())*12.0
                    width=float(self.width.get())*12.0
                    width2=float(self.width2.get())*12
                    colA=float(self.colA.get())
                    colI=float(self.colI.get())
                    fixity=self.fixity.get()
                    bmA=float(self.bmA.get())
                    ...
                    w=float(self.w.get())/12000.0
                    w2=float(self.w2.get())/12000.0
                    w3=float(self.w3.get())/12000.0
                    w4=float(self.w4.get())/12000.0
                    P=float(self.P.get())/1000.0
                    P2=float(self.P2.get())/1000.0
                    P3=float(self.P3.get())/1000.0
                    P4=float(self.P4.get())/1000.0
                    x=float(self.x.get())*12.0
                    x2=float(self.x2.get())*12.0
                    x3=float(self.x4.get())*12.0
                    x4=float(self.x4.get())*12.0
                    pdelta=self.pdelta.get()
                    loadstype=self.loadstype.get()
                    pdeltaconvtol=float(self.pdeltaconvtol.get())
                    ...
                    col1props=[E,colA,colI,height,'up',fixity]
                    col1dofs=[0,1,2,3,4,5]
                    col2props=[E,colA,colI,height2,'up','1']
                    col2dofs=[3,4,5,6,7,8]
                    col3props=[E,colA,colI,height,'up',fixity]
                    col3dofs=[9,10,11,12,13,14]
                    col4props=[E,colA,colI,height2,'up','1']
                    col4dofs=[9,10,11,12,13,14]
                    col5props=[E,colA,colI,height,'up',fixity]
                    col5dofs=[18,19,20,21,22,23]
                    col6props=[E,colA,colI,height2,'up','1']
                    col6dofs=[21,22,23,24,25,26]
                    bm1props=[E,bmA,bmI,width,'up','1']
                    bm1dofs=[3,4,5,12,13,14]
                    bm2props=[E,bmA,bmI,width,'up','1']
                    bm2dofs=[6,7,8,15,16,17]
                    bm3props=[E,bmA,bmI,width2,'up','1']
                    bm3dofs=[12,13,14,21,22,23]
                    bm4props=[E,bmA,bmI,width2,'up','1']
                    bm4dofs=[15,16,17,24,25,26]
                    
                    col1localk=k_matrix(*col1props)
                    col2localk=k_matrix(*col2props)
                    col3localk=k_matrix(*col3props)
                    col4localk=k_matrix(*col4props)
                    col5localk=k_matrix(*col5props)
                    col6localk=k_matrix(*col6props)
                    bm1localk=k_matrix(*bm1props) 
                    bm2localk=k_matrix(*bm2props)
                    bm3localk=k_matrix(*bm3props)
                    bm4localk=k_matrix(*bm4props)
                    
                    col1globalk=global_transform(col1localk,0,height,height)
                    col2globalk=global_transform(col2localk,0,height2,height2)
                    col3globalk=global_transform(col3localk,0,height,height)
                    col4globalk=global_transform(col4localk,0,height2,height2)
                    col5globalk=global_transform(col5localk,0,height,height)
                    col6globalk=global_transform(col6localk,0,height2,height2)
                    bm1globalk=global_transform(bm1localk,width,0,width)
                    bm2globalk=global_transform(bm2localk,width,0,width)
                    bm3globalk=global_transform(bm3localk,width2,0,width2)
                    bm4globalk=global_transform(bm4localk,width2,0,width2)
                    
                    glmatrix=combine_matrices_2b2s(col1globalk,col2globalk,col3globalk,col4globalk,col5globalk,col6globalk,bm1globalk,bm2globalk,bm3globalk,bm4globalk)
                    new_indexes=[3,4,5,12,13,14,21,22,23,6,7,8,15,16,17,24,25,26,0,1,2,9,10,11,18,19,20]
                    glmatrix_rearranged=np.zeros((27,27))
                    glmatrix_rearranged+=[[glmatrix[i][j] for j in new_indexes] for i in new_indexes]
                    
                    fef=np.zeros(18)
                    fef1=beam_fef(P,width,x,w,width,0)
                    fef2=beam_fef(P2,width,x2,w2,width,0)
                    fef3=beam_fef(P3,width2,x3,w3,width2,0)
                    fef4=beam_fef(P4,width2,x4,w4,width2,0)
                    fef[:3]+=fef1[:3]
                    fef[3:6]+=fef2[:3]
                    fef[6:9]+=fef1[3:]
                    fef[6:9]+=fef3[:3]
                    ...
                    F=loads-fef  
                    colF=np.zeros(6)
                    d=np.linalg.solve(glmatrix_rearranged[0:18,0:18],F)
                    dglob=np.zeros(27)
                    dglob[:18]+=d
                    ...
                    col1R=member_forces(col1v,0,height,height,col1localk,colF)
                    col2R=member_forces(col2v,0,height2,height2,col2localk,colF)
                    col3R=member_forces(col3v,0,height,height,col3localk,colF)
                    col4R=member_forces(col4v,0,height2,height2,col4localk,colF)
                    col5R=member_forces(col5v,0,height,height,col5localk,colF)
                    col6R=member_forces(col6v,0,height2,height2,col6localk,colF)
                    bm1R=member_forces(bm1v,width,0,width,bm1localk,[*F[0:3],*F[6:9]])
                    bm2R=member_forces(bm2v,width,0,width,bm2localk,[*F[3:6],*F[9:12]])
                    bm3R=member_forces(bm3v,width2,0,width2,bm3localk,[*F[6:9],*F[12:15]])
                    bm4R=member_forces(bm4v,width2,0,width2,bm4localk,[*F[9:12],*F[15:]])
                    ...
                    d[8]=d[8]*180/3.14159
                    d[11]=d[11]*180/3.14159
                    d[14]=d[14]*180/3.14159
                    d[17]=d[17]*180/3.14159
                    ...
                    if pdelta=='1':
                        ...
                        while convergence<=pdeltaconvtol:    
                            ...
                            col1pd_v=d[0]*col1R[4]/height
                            F[0]+=col1pd_v
                            col2pd_v=d[3]*col2R[4]/height2
                            F[3]+=col2pd_v
                            col3pd_v=d[6]*col3R[4]/height
                            F[6]+=col3pd_v
                            col4pd_v=d[9]*col4R[4]/height2
                            F[9]+=col4pd_v
                            col5pd_v=d[12]*col5R[4]/height
                            F[12]+=col5pd_v
                            col6pd_v=d[15]*col6R[4]/height2
                            F[15]+=col6pd_v
                                                        
                            d=np.linalg.solve(glmatrix_rearranged[:18,:18],F)      #[x1,y2,rot]
                            dglob=np.zeros(27)
                            dglob[:18]+=d    
                    ...
                    bm1M=beam_moment(-1*bm1R[2],bm1R[5],P,x,w,width)
                    bm2M=beam_moment(-1*bm2R[2],bm2R[5],P2,x2,w2,width)
                    bm3M=beam_moment(-1*bm3R[2],bm3R[5],P3,x3,w3,width2)
                    bm4M=beam_moment(-1*bm4R[2],bm4R[5],P4,x4,w4,width2)
                    col1M=[-1*col1R[2]/12,col1R[5]/12]
                    col2M=[col2R[2]/12,-1*col2R[5]/12]     
                    col3M=[col3R[2]/12,-1*col3R[5]/12]  
                    col4M=[col4R[2]/12,-1*col4R[5]/12]
                    col5M=[col5R[2]/12,-1*col5R[5]/12]
                    col6M=[col6R[2]/12,-1*col6R[5]/12]
                    ...
                    dx3_label=tk.Label(canvas,text='dx= '+str(round(d[3],3))+' in') 
                    canvas.create_window(startx+2,starty-ydim-62,window=dx3_label,anchor='nw')
                    dy3_label=tk.Label(canvas,text='dy= '+str(round(d[4],3))+' in')
                    canvas.create_window(startx+2,starty-ydim-45,window=dy3_label,anchor='nw')
                    rot3_label=tk.Label(canvas,text='rot= '+str(round(d[5],3))+' deg')
                    canvas.create_window(startx+2,starty-ydim-28,window=rot3_label,anchor='nw')
                    
                    dx5_label=tk.Label(canvas,text='dx= '+str(round(d[6],3))+' in') 
                    canvas.create_window(startx+xdim/2+2,starty-ydim/2-62,window=dx5_label,anchor='nw')
                    dy5_label=tk.Label(canvas,text='dy= '+str(round(d[7],3))+' in')
                    canvas.create_window(startx+xdim/2+2,starty-ydim/2-45,window=dy5_label,anchor='nw')
                    rot5_label=tk.Label(canvas,text='rot= '+str(round(d[8],3))+' deg')
                    canvas.create_window(startx+xdim/2+2,starty-ydim/2-28,window=rot5_label,anchor='nw')
                    
                    dx6_label=tk.Label(canvas,text='dx= '+str(round(d[9],3))+' in') 
                    canvas.create_window(startx+xdim/2,starty-ydim-62,window=dx6_label,anchor='nw')
                    dy6_label=tk.Label(canvas,text='dy= '+str(round(d[10],3))+' in')
                    canvas.create_window(startx+xdim/2,starty-ydim-45,window=dy6_label,anchor='nw')
                    rot6_label=tk.Label(canvas,text='rot= '+str(round(d[11],3))+' deg')
                    canvas.create_window(startx+xdim/2,starty-ydim-28,window=rot6_label,anchor='nw')
                    
                    dx8_label=tk.Label(canvas,text='dx= '+str(round(d[12],3))+' in') 
                    canvas.create_window(startx+xdim+2,starty-ydim/2-62,window=dx8_label,anchor='nw')
                    dy8_label=tk.Label(canvas,text='dy= '+str(round(d[13],3))+' in')
                    canvas.create_window(startx+xdim+2,starty-ydim/2-45,window=dy8_label,anchor='nw')
                    rot8_label=tk.Label(canvas,text='rot= '+str(round(d[14],3))+' deg')
                    canvas.create_window(startx+xdim+2,starty-ydim/2-28,window=rot8_label,anchor='nw')
                    
                    dx9_label=tk.Label(canvas,text='dx= '+str(round(d[15],3))+' in') 
                    canvas.create_window(startx+xdim,starty-ydim-62,window=dx9_label,anchor='nw')
                    dy9_label=tk.Label(canvas,text='dy= '+str(round(d[16],3))+' in')
                    canvas.create_window(startx+xdim,starty-ydim-45,window=dy9_label,anchor='nw')
                    rot9_label=tk.Label(canvas,text='rot= '+str(round(d[17],3))+' deg')
                    canvas.create_window(startx+xdim,starty-ydim-28,window=rot9_label,anchor='nw')
                    ...
                    M4_label=tk.Label(canvas,text='M= '+str(round(r[5],3))+' ft-k')
                    canvas.create_window(startx+xdim/2,starty+34,window=M4_label,anchor='nw')
                    rx7_label=tk.Label(canvas,text='Rx= '+str(round(r[6],3))+' k')   
                    canvas.create_window(startx+xdim,starty,window=rx7_label,anchor='nw')
                    ry7_label=tk.Label(canvas,text='Ry= '+str(round(r[7],3))+' k')
                    canvas.create_window(startx+xdim,starty+17,window=ry7_label,anchor='nw')
                    M7_label=tk.Label(canvas,text='M= '+str(round(r[8],3))+' ft-k')
                    canvas.create_window(startx+xdim,starty+34,window=M7_label,anchor='nw')
                    
                    #max moment label placement
                    bm1Mmax_label=tk.Label(canvas,text='Mmax= '+str(round(bm1M[0],1))+' ft-k')
                    canvas.create_window(startx+xdim/6,starty-ydim/2+2,window=bm1Mmax_label,anchor='nw')
                    bm1Mmin_label=tk.Label(canvas,text='Mmin= '+str(round(bm1M[1],1))+' ft-k')
                    canvas.create_window(startx+xdim/6,starty-ydim/2+18,window=bm1Mmin_label,anchor='nw')
                    bm2Mmax_label=tk.Label(canvas,text='Mmax= '+str(round(bm2M[0],1))+' ft-k')
                    canvas.create_window(startx+xdim/6,starty-ydim+2,window=bm2Mmax_label,anchor='nw')
                    bm2Mmin_label=tk.Label(canvas,text='Mmin= '+str(round(bm2M[1],1))+' ft-k')
                    canvas.create_window(startx+xdim/6,starty-ydim+18,window=bm2Mmin_label,anchor='nw') 
                    bm3Mmax_label=tk.Label(canvas,text='Mmax= '+str(round(bm3M[0],1))+' ft-k')
                    canvas.create_window(startx+xdim*4/6,starty-ydim/2+2,window=bm3Mmax_label,anchor='nw')
                    bm3Mmin_label=tk.Label(canvas,text='Mmin= '+str(round(bm3M[1],1))+' ft-k')
                    canvas.create_window(startx+xdim*4/6,starty-ydim/2+18,window=bm3Mmin_label,anchor='nw')
                    bm4Mmax_label=tk.Label(canvas,text='Mmax= '+str(round(bm4M[0],1))+' ft-k')
                    canvas.create_window(startx+xdim*4/6,starty-ydim+2,window=bm4Mmax_label,anchor='nw')
                    bm4Mmin_label=tk.Label(canvas,text='Mmin= '+str(round(bm4M[1],1))+' ft-k')
                    canvas.create_window(startx+xdim*4/6,starty-ydim+18,window=bm4Mmin_label,anchor='nw')
                    
                    c1Mmax_label=tk.Label(canvas,text='Mmax= '+str(round(col1M[1],1))+' ft-k')
                    canvas.create_window(startx+2,starty-ydim/4-24,window=c1Mmax_label,anchor='nw')
                    c1Mmin_label=tk.Label(canvas,text='Mmin= '+str(round(col1M[0],1))+' ft-k')
                    canvas.create_window(startx+2,starty-ydim/4-8,window=c1Mmin_label,anchor='nw')
                    c2Mmax_label=tk.Label(canvas,text='Mmax= '+str(round(col2M[0],1))+' ft-k')
                    canvas.create_window(startx+2,starty-ydim*3/4-24,window=c2Mmax_label,anchor='nw')
                    c2Mmin_label=tk.Label(canvas,text='Mmin= '+str(round(col2M[1],1))+' ft-k')
                    canvas.create_window(startx+2,starty-ydim*3/4-8,window=c2Mmin_label,anchor='nw')
                    c3Mmax_label=tk.Label(canvas,text='Mmax= '+str(round(col3M[0],1))+' ft-k')
                    canvas.create_window(startx+xdim/2+2,starty-ydim/4-24,window=c3Mmax_label,anchor='nw')
                    c3Mmin_label=tk.Label(canvas,text='Mmin= '+str(round(col3M[1],1))+' ft-k')
                    canvas.create_window(startx+xdim/2+2,starty-ydim/4-8,window=c3Mmin_label,anchor='nw')
                    c4Mmax_label=tk.Label(canvas,text='Mmax= '+str(round(col4M[0],1))+' ft-k')
                    canvas.create_window(startx+xdim/2+2,starty-ydim*3/4-24,window=c4Mmax_label,anchor='nw')
                    c4Mmin_label=tk.Label(canvas,text='Mmin= '+str(round(col4M[1],1))+' ft-k')
                    canvas.create_window(startx+xdim/2+2,starty-ydim*3/4-8,window=c4Mmin_label,anchor='nw')
                    c5Mmax_label=tk.Label(canvas,text='Mmax= '+str(round(col5M[0],1))+' ft-k')
                    canvas.create_window(startx+xdim+2,starty-ydim/4-24,window=c5Mmax_label,anchor='nw')
                    c5Mmin_label=tk.Label(canvas,text='Mmin= '+str(round(col5M[1],1))+' ft-k')
                    canvas.create_window(startx+xdim+2,starty-ydim/4-8,window=c5Mmin_label,anchor='nw')
                    c6Mmax_label=tk.Label(canvas,text='Mmax= '+str(round(col6M[0],1))+' ft-k')
                    canvas.create_window(startx+xdim+2,starty-ydim*3/4-24,window=c6Mmax_label,anchor='nw')
                    c6Mmin_label=tk.Label(canvas,text='Mmin= '+str(round(col6M[1],1))+' ft-k')
                    canvas.create_window(startx+xdim+2,starty-ydim*3/4-8,window=c6Mmin_label,anchor='nw')
    
                    drift_label1=tk.Label(canvas,text='Story Drift = L/'+str(int(round(height/max(d[0],d[3]),0))))
                    canvas.create_window((startx+xdim/2)/2-175,starty-ydim/4,window=drift_label1,anchor='nw')
                    
                    drift_label2=tk.Label(canvas,text='Story Drift = L/'+str(int(round(height2/max(d[6]-d[0],d[9]-d[3]),0))))
                    canvas.create_window((startx+xdim/2)/2-175,starty-ydim*3/4,window=drift_label2,anchor='nw')    
